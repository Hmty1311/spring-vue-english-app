...
| 物理名 | 論理名 | 型 | PK | FK | NOT NULL |
| --- | --- | --- | --- | --- | --- |
| word_id | 単語ID | BIGINT | ○ | WORDS.id | ○ |
| tag_id | タグID | BIGINT | ○ | TAGS.id | ○ |

- 複合主キー: (word_id, tag_id)
...
| 物理名 | 論理名 | 型 | PK | FK | NOT NULL |
| --- | --- | --- | --- | --- | --- |
| phrase_id | 熟語ID | BIGINT | ○ | PHRASES.id | ○ |
| tag_id | タグID | BIGINT | ○ | TAGS.id | ○ |

- 複合主キー: (phrase_id, tag_id)
